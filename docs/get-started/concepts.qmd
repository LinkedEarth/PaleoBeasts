...
This page explains the three building blocks that every ClimateCritters workflow uses: `Model`, `Forcing`, and `Output`.

## cc.Model

`Model` is the abstract base class for all signal models. You never instantiate it directly — instead you use one of the concrete subclasses (e.g. `Lorenz63`, `EBM`, `Stommel`).
